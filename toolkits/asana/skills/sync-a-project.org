#+TITLE: Asana connector — sync a project into a Board
#+TOOLKIT: asana
#+SKILL: sync-a-project
#+VERSION: 0.1.0
#+DESCRIPTION: Stand up the config-gated :beam sync daemon that mirrors an Asana project into an org-native Board.
#+TAGS: federation asana sync
#+STATUS: experimental
