...
#+CAPTION: The gate between "builds on my machine" and "I can share it." Uses raw cargo tauri build (Tauri reads the signing env vars natively).
...
NOTE: there is no =work forge desktop= command (the Rust =wb= that provided it,
