#+TITLE: Linear connector — sync a project into a Board
#+TOOLKIT: linear
#+SKILL: sync-a-project
#+VERSION: 0.1.0
#+DESCRIPTION: Stand up the config-gated :beam sync daemon that mirrors a Linear project into an org-native Board.
#+TAGS: federation linear sync
#+STATUS: experimental
