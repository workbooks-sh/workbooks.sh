...
#+DATE: 2026-06-05
#+EPIC: wb-skv2
#+RELATED: ../runtime/docs/TOOLKITS-V3.org (authoritative, clean-room), ../runtime/docs/TOOLKITS-PLAN.org, ../runtime/docs/TOOLKIT-SKILLS-V2.org, ../runtime/docs/TOOLKIT-DISCOVERY.org
...
VFS integration — read ../runtime/docs/TOOLKITS-V3.org first. This file remains
