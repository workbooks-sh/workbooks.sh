...
globalThis.valtypeOverrides = {
  returns: {
    // array spill (wb-9yie ch2): these return `any` (value f64 + type i32). Without the [f64,i32]
    // arity override they compile as a 1-result signature and get validated out of the bundle (a
    // guest then hits "__Porffor_array_chainGet has no built-in!").
    __Porffor_array_chainGet: [ Valtype.f64, Valtype.i32 ],
    __Porffor_array_readAt: [ Valtype.f64, Valtype.i32 ],
    ...
    // BigInt values are carried as f64 (inline value, or `realPtr + 2^51` offset pointer up to 2^53), so the
    // bigint runtime ops must take/return f64 — without these they default to i32-valtype, truncating the
    // value AND overflowing the 2^51 boundary constant to an out-of-range i32.const (which traps at runtime).
    __Porffor_bigint_inlineToDigitForm: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_cmp: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_fromDigits: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_fromNumber: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_toNumber: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_add: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_sub: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_addOp: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_mul: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_div: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_rem: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_divrem: [ Valtype.f64, Valtype.i32 ]
  },
  params: {
    ...
    // BigInt ops: every JS value-param is an (f64 value, i32 type) pair. inlineToDigitForm/cmp + the six
    // comparisons take f64 bigint values; bool/sub flags stay i32. (add/sub/mul/div/rem get the same
    // treatment when their bodies are wired.)
    __Porffor_bigint_inlineToDigitForm: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_fromNumber: [ Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_toNumber: [ Valtype.f64, Valtype.i32 ],
    // fromDigits(negative: boolean, digits: i32[]) → (i32 flag, i32 array ptr) — no f64 value-params
    __Porffor_bigint_add: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32, Valtype.i32, Valtype.i32 ],
    __Porffor_bigint_sub: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_addOp: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_mul: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_div: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_rem: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_divrem: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32, Valtype.i32, Valtype.i32 ],
    __Porffor_bigint_toString: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_cmp: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_eq: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_ne: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_gt: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_ge: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_lt: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ],
    __Porffor_bigint_le: [ Valtype.f64, Valtype.i32, Valtype.f64, Valtype.i32 ]
  }
};
