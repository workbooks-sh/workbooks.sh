# Toolkit commands — `work toolkit`, `work compiler`, `work isolation`
...
**Where these run:** in-process (an agent calling `work`) they run locally over the
...
## Discover — `work toolkit list | show | search`
...
## Self-author — `work toolkit build-inline`, `work toolkit promote`
...
## Run a task — `work toolkit run <id> <task> -- <args…>`
