<!--
  AgentLogos — real brand marks for Claude Code, Codex, and Cursor.
  Source: lobehub/lobe-icons (MIT).
    https://github.com/lobehub/lobe-icons/tree/master/packages/static-svg/icons
  All use currentColor so callers control the color via text-* utilities.
-->
<script lang="ts">
  interface Props {
  ...
  let { name, size = 18, title }: Props = $props();
</script>
