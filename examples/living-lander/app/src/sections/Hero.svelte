...
<main class="hero">
  ...
  <h1 class="blk" id="b-h1"><span id="h1text" bind:this={h1textEl}></span><span class="caret" id="caret" bind:this={caretEl} hidden></span></h1>
