...
<section id="get" class="band">
 <div class="inner">
  <div class="kicker reveal" use:reveal>03 · get workbooks</div>
  <h2 class="reveal" use:reveal>Start on your desktop</h2>
  <p class="lede reveal" use:reveal>The desktop app runs the whole ecosystem on your
