/*!
 * VENDORED — source of truth: toolkits/open-avatars/dist/open-avatars.js
 * (pairs with ./open-peeps.bundle.json ← toolkits/open-avatars/packs/open-peeps/pack.bundle.json).
 * Re-copy both from there on upstream change; do not edit here.
 *
