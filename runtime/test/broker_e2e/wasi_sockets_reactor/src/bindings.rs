...
pub unsafe fn _export_probe_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let len0 = arg1;
    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    let result1 = T::probe(_rt::string_lift(bytes0));
...
pub trait Guest {
    fn probe(target: _rt::String) -> _rt::String;
}
#[doc(hidden)]
macro_rules! __export_world_example_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[unsafe (export_name = "probe")] unsafe extern "C" fn
        export_probe(arg0 : * mut u8, arg1 : usize,) -> * mut u8 { unsafe {
        $($path_to_types)*:: _export_probe_cabi::<$ty > (arg0, arg1) } } #[unsafe
        (export_name = "cabi_post_probe")] unsafe extern "C" fn _post_return_probe(arg0 :
        * mut u8,) { unsafe { $($path_to_types)*:: __post_return_probe::<$ty > (arg0) } }
        };
    };
}
#[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:netprobe:example:encoded world"
)]
#[doc(hidden)]
...
@\x01\x06targets\0s\x04\0\x05probe\x01\0\x04\0\x1acomponent:netprobe/example\x04\
