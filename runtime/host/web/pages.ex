defmodule Workbooks.Web.Pages do
  @moduledoc """
  Server-rendered HTML pages for `Workbooks.Web` — the document viewer SPA, the
  built-in sample workbook, and the per-workbook page shell. Pure render helpers
  (no `conn`): the router calls these and writes the result with `send_resp`.
  """
  ...
  def workbook_page(id, rendered) do
    """
