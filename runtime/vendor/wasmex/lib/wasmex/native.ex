defmodule Wasmex.Native do
  ...
  use RustlerPrecompiled,
    ...
    # wb-v3d: this is a VENDORED, patched wasmex (engine.rs enables the wasm exception proposal so
    # mrustc_pm.wasm can run for proc-macro expansion). The upstream precompiled NIF lacks that
    # patch, so always build from source — no WASMEX_BUILD env, no deps.get reversion.
    force_build: true
