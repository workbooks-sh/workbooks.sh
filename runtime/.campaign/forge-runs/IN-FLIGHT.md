...
| a6504755b492925be | mrustc codegen patch (rayon futex + SIMD intrinsics) | forge-runs/mrustc-codegen-patch.md | DIED early (nothing landed) — re-launching solo (see next row) |
