...
- **RUBRIC:** The answer names `work app status` as the probe, and explains that drive commands are SAFE NO-OPS when nothing is connected (they report "no desktop shell connected" rather than erroring), so you act optimistically and report honestly.
