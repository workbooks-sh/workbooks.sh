defmodule Nexus.Porffor.GeneratorFiber do
  @moduledoc """
  **Host-side driver for JS generators lowered onto Washy suspension fibers.**

  A generator INSTANCE is a fiber (see `Nexus.Porffor.AsyncFiber`): `g()` spawns it, `it.next(v)` resumes it,
