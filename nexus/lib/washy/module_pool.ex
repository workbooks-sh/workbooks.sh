defmodule Nexus.Washy.ModulePool do
  @moduledoc """
  ...
  **kills processes still executing the old version**. We NEVER hard-purge:
  ...
  recompiles into a fresh slot. See `Nexus.Washy.Transpile.cached_one/2`.
  ...
  # cache entries lazily recompile on next use. Configurable via `config :nexus, Nexus.Washy.ModulePool,
