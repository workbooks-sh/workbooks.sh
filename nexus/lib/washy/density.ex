defmodule Nexus.Washy.Density do
  @moduledoc """
  Density telemetry — the live picture of the *hard walls* the Washy runtime must watch BEFORE they crash
  ...
  We also fold in the cheap recovery levers already measured by `Nexus.Washy.Metrics.snapshot/0`
