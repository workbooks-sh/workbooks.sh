defmodule Nexus.Washy.Trap do
  @moduledoc """
  A **wasm trap** — the structured, catchable signal both Washy backends raise on a spec-defined
  ...
  *identically* (same `reason`), not merely that both happen to fail.
      ...
      raise Nexus.Washy.Trap, reason: :out_of_bounds
  """
  defexception [:reason]
