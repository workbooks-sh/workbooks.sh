defmodule Nexus.Washy.TranspileAsm do
  ...
  **Supported ops:** i32 const, `local.get/set/tee`, `drop`, `nop`; i32 arith/bitwise (add/sub/mul/and/
  ...
  @op_handlers [Nexus.Washy.AsmOps.Memory, Nexus.Washy.AsmOps.I64, Nexus.Washy.AsmOps.Floats, Nexus.Washy.AsmOps.IntExt, Nexus.Washy.AsmOps.Tables, Nexus.Washy.AsmOps.Atomics]
