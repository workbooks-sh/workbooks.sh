  ...
  **serving** context (a release, or `WB_SERVE`/`WB_DESKTOP` set) it also brings up `Nexus.Server`
  ...
  def start(_type, _args) do
    ...
    children =
      ...
      [Nexus.Broker, Nexus.Telemetry, Nexus.Autopoet.Lease, Nexus.Analytics, Nexus.ControlPlane.Store, Nexus.ControlPlane.Token, Nexus.Auth.Token, Nexus.Washy.JitCache] ++
