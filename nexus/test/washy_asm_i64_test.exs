defmodule Nexus.WashyAsmI64Test do
  @moduledoc """
  **i64 op-group for the BEAM-assembly lane (`Nexus.Washy.AsmOps.I64`).** The asm lane only attempts
  ...
  test "i64.div_s INT64_MIN / -1 traps :int_overflow like the interpreter" do
    ...
    assert_raise Nexus.Washy.Trap, fn -> apply(am, af, [0x80000000, 0xFFFFFFFF]) end
  end
