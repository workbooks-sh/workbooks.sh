...
// The onboarding answers, persisted so the dashboard can seed the org identity +
// first nexus from what the user told us — instead of generic demo content.
//
...
const ALLOWED_TIERS = ['free', 'starter', 'team', 'scale', 'ent'];
