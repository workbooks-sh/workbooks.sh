...
(function () {
  ...
  var css = [
    ...
    '  display: none; flex-direction: column; min-width: 240px; background: var(--paper, #f7f6f1);',
    ...
    '  color: var(--dim, #565b54); margin-left: auto; font-size: 10px; }',
    ...
    '@media (max-width: 820px) { .nav { gap: 14px; padding: 8px 12px; top: 12px; max-width: 94vw; } }',
  ].join("\n");
  ...
  var html =
    ...
    '<div class="drop"><a href="#">Learn</a><div class="panel">' +
  ...
  var drop = nav.querySelector(".drop > a");
  drop.addEventListener("click", function (e) { e.preventDefault(); drop.parentElement.classList.toggle("open"); });
})();
