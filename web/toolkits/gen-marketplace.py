...
paper #f7f6f1, ink #121316, Groothan display, JetBrains Mono body — all
sans/mono, NO serif, NO green. Color comes from the BRAND PASTELS used as
...
.card .hd{ min-width:0; }
.card h3{ font-family:var(--display); font-weight:400; font-size:25px; line-height:1;
...
.dhead h1{ font-family:var(--display); font-weight:400; font-size:clamp(40px,5.5vw,68px); line-height:.94; }
...
.sec h2{ font-family:var(--display); font-weight:400; font-size:30px; margin-bottom:16px; }
