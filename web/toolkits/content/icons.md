...
Experimental (v0.1.0). Builds in-sandbox via the StarlingMonkey lane (`work toolkit build icons`); the same file also runs under plain `node src/index.js` outside the runtime.
