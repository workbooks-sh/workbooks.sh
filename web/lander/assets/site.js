...
(() => {
  ...
  nav.innerHTML = `
    <a class="glyph" href="/" aria-label="Workbooks home">
      <svg viewBox="0 0 280 206" fill="none"><path d="M0 206V0.00231123H69.1194V76L126.393 0L168.946 0.00231123V76L223.295 0L280 0.00231147L223.295 88L248.626 176.683C252.823 191.375 241.791 206 226.511 206H116.27L112.626 140.5L41.5 206H0Z" fill="currentColor"/></svg>
    </a>
