#+TITLE: What is a toolkit
#+DESCRIPTION: A toolkit is the unit of capability — packaged sandboxed WASM, authored in any language, run isolated, shipped inside a workbook.
...
selects how the artifact is invoked. See [[exec-shapes.org][the six shapes]] for what each is for.
...
host does the work. See [[the-dock.org][the Dock & capabilities]].
...
tighten. See [[isolation.org][isolation tiers]].
...
[[../start/first-toolkit.org][Build one →]]
