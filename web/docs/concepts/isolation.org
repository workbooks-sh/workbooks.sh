...
#+DESCRIPTION: Four escalating containment tiers, assigned by the host, never by the toolkit.
...
move. See [[../run/fabric.org][the fabric]].

- Pick a trust posture: [[../run/tiers.org][Isolation tiers & trust]]
