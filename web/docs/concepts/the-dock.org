#+TITLE: The Dock & capabilities
#+DESCRIPTION: The typed, capability-gated surface a toolkit uses to reach the host.
...
- Author against the Dock: [[../build/dock-sdk.org][The Dock SDK]]
- Full list: [[../reference/caps.org][Dock capabilities]]
