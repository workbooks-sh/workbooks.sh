...
> Reference for the desktop app: the Host capability surface, the dock/panel extension model, and the Browser SDK.
...
`desktop/src/lib/sdk/` (the Browser SDK). See [host vs loaded](../concepts/two-surfaces.md) and
[the Dock](../concepts/the-dock.md) for the why; [/learn/the-seam](../../learn/the-seam.html) for the deep page.
...
This is what makes the browser [workbook-native](../../learn/workbook.html) and offline-first.
...
`gated_route` (`desktop/src/lib/rcp/routing.ts:14`). See [/learn/nexus](../../learn/nexus.html) and
RCP `wb-uxn`.
...
built in workbooks" applied to the browser's own surface. See [EXEC shapes](../concepts/exec-shapes.md).
...
- [Host vs loaded](../concepts/two-surfaces.md) · [The Dock](../concepts/the-dock.md) · [EXEC shapes](../concepts/exec-shapes.md)
- Deep pages: [the seam](../../learn/the-seam.html) · [the one file](../../learn/the-one-file.html) · [the kernel](../../learn/the-kernel.html) · [the nexus](../../learn/nexus.html)
