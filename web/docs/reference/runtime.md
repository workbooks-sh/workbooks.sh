...
> The runtime's HTTP/WebSocket/RCP API: two planes, auth ladder, every route — method, path, auth rung, source anchor.
...
- [The Dock & capabilities](../concepts/the-dock.md) — the membrane the runtime brokers.
- [Dock capabilities reference](./caps.md) — the capability grants.
- [wbx CLI reference](./cli.md) — the verbs that drive the RCP surface.
