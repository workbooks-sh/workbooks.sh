...
> The runtime host (runtime/host/*.ex) by subsystem — exhaustive, source-anchored, maturity-tagged.
...
the deep pages under [/learn](https://workbooks.sh/learn/safe-powers.html); for the **external** RCP/HTTP API see the
...
- [Dock capabilities](caps.md) · [Dock SDK API](sdk.md) · [#+EXEC shapes](exec-shapes.md) — the author-facing surface of what this engine runs.
- [/learn: safe powers](https://workbooks.sh/learn/safe-powers.html) · [under the hood](https://workbooks.sh/learn/under-the-hood.html) — the narrative explanation tier.
