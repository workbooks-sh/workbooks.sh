#+TITLE: wbx CLI
#+DESCRIPTION: Every wbx verb, flag, mode, env var, and exit code — tangled from the clap surface.
...
:CAVEAT:   runtime/host/cli.ex is the pre-wbx escript (~29 verbs / 67 forms,
           ...
           to this crate, but =wbx= (Rust) is the canonical home going forward.
