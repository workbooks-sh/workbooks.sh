  ...
  (function () {
    ...
    document.addEventListener('click', function (e) {
      ...
      var tfile = t.closest && t.closest('[data-tree-file]'); if (tfile) { WB.toast('Open “' + tfile.getAttribute('data-tree-file') + '” — file view coming'); return; }
      ...
      var wsopen = t.closest && t.closest('[data-wsopen]'); if (wsopen) { WB.ws.setActive(wsopen.getAttribute('data-wsopen')); WB.nav('/workspace'); return; }
