...
export const toolkits = $state([
  ...
  { id: 'aws', name: 'AWS', summary: 'The AWS CLI — S3, Lambda & the rest', glyph: 'brand:amazonaws', fallback: 'cloud', category: 'Dev & deploy', kind: 'integration', lang: 'python', tier: 'execute', wasmStatus: 'planned', auth: 'api_key', tools: ['s3', 'lambda', 'ec2'], enabled: false, connected: false }
])
